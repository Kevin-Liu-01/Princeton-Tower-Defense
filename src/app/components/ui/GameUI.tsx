...
export const TopHUD: React.FC<TopHUDProps> = ({
  ...
  return (
    <OrnateFrame
      className="bg-gradient-to-r from-amber-900 via-yellow-900 to-amber-900 border-b-2 border-amber-600 shadow-lg relative flex-shrink-0"
      cornerSize={28}
      showBorders={true}
    >
      <div
        className="px-3 py-1.5 flex flex-col sm:flex-row items-center relative z-20"
        style={{ zIndex: 100 }}
      >
...
export const BuildMenu: React.FC<BuildMenuProps> = ({
  ...
  return (
    <OrnateFrame
      className="bg-gradient-to-br from-amber-900/95 to-amber-950/95 border-t-2 border-amber-600 shadow-xl backdrop-blur-sm"
      cornerSize={28}
      showBorders={true}
    >
      <div
        className="px-1.5 sm:px-3 py-1.5 sm:py-2 overflow-x-auto relative z-20"
        style={{ zIndex: 100 }}
      >
...
export const EnemyDetailTooltip: React.FC<EnemyDetailTooltipProps> = ({
  ...
  return (
    <div
      className="fixed pointer-events-auto bg-gradient-to-br from-stone-900/98 to-purple-950/98 border-2 border-purple-500/70 shadow-2xl rounded-xl backdrop-blur-md overflow-hidden"
      style={{ left: tooltipX, top: tooltipY, zIndex: 300, width: tooltipWidth }}
      onClick={(e) => e.stopPropagation()}
    >
      {/* Header */}
      <div className="bg-gradient-to-r from-purple-900/60 to-rose-900/40 px-4 py-3 border-b border-purple-700/50 flex items-center justify-between">
