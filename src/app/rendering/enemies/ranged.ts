...
export function drawArcherEnemy(
  ...
  const capeBot = 0.28;
  const capeGrad = ctx.createLinearGradient(cx, y - size * 0.38, cx, y + size * (capeBot + 0.04));
  ...
  ctx.bezierCurveTo(
    cx - size * 0.34 + capeWave, y - size * 0.05,
    cx - size * 0.36 + capeWave2, y + size * 0.1,
    cx - size * 0.26 + Math.sin(time * 2.2) * size * 0.025, y + size * capeBot,
  );
  for (let t = 0; t < 10; t++) {
    const tx = cx - size * 0.26 + t * size * 0.055 + Math.sin(time * 2.5 + t * 0.9) * size * 0.012;
    const depth = (t % 2 === 0) ? size * 0.035 : -size * 0.012;
    const ty = y + size * capeBot + depth + Math.sin(time * 3.2 + t * 0.7) * size * 0.015;
    ctx.lineTo(tx, ty);
  }
  ctx.bezierCurveTo(
    cx + size * 0.36 + capeWave2 * 0.5, y + size * 0.1,
    cx + size * 0.34 + capeWave * 0.5, y - size * 0.05,
    cx + size * 0.2, y - size * 0.36 - bodyBob,
  );
  ctx.closePath();
  ctx.fill();
  ...
  ctx.beginPath();
  ctx.moveTo(cx - size * 0.26 + Math.sin(time * 2.2) * size * 0.025, y + size * capeBot);
  for (let t = 0; t < 10; t++) {
    const tx = cx - size * 0.26 + t * size * 0.055 + Math.sin(time * 2.5 + t * 0.9) * size * 0.012;
    const depth = (t % 2 === 0) ? size * 0.035 : -size * 0.012;
    const ty = y + size * capeBot + depth + Math.sin(time * 3.2 + t * 0.7) * size * 0.015;
  ...
  ctx.beginPath();
  ctx.moveTo(cx - size * 0.24 + Math.sin(time * 2.2) * size * 0.02, y + size * (capeBot - 0.025));
  for (let t = 0; t < 9; t++) {
    const tx = cx - size * 0.24 + t * size * 0.055 + Math.sin(time * 2.5 + t * 0.9) * size * 0.01;
    const depth = (t % 2 === 0) ? size * 0.025 : -size * 0.008;
    const ty = y + size * (capeBot - 0.025) + depth + Math.sin(time * 3.2 + t * 0.7) * size * 0.012;
    ctx.lineTo(tx, ty);
  }
  ctx.stroke();
  ...
  for (let t = 0; t < 10; t++) {
    const tx = cx - size * 0.24 + t * size * 0.052 + Math.sin(time * 2.5 + t * 0.8) * size * 0.01;
  ...
  ctx.quadraticCurveTo(cx - size * 0.06, embY + size * 0.02, cx - size * 0.04, embY - size * 0.02);
  ctx.quadraticCurveTo(cx - size * 0.02, embY - size * 0.05, cx, embY - size * 0.06);
  ctx.quadraticCurveTo(cx + size * 0.02, embY - size * 0.05, cx + size * 0.04, embY - size * 0.02);
  ctx.quadraticCurveTo(cx + size * 0.06, embY + size * 0.02, cx + size * 0.04, embY + size * 0.06);
  ctx.quadraticCurveTo(cx + size * 0.02, embY + size * 0.08, cx, embY + size * 0.07);
  ctx.quadraticCurveTo(cx - size * 0.02, embY + size * 0.08, cx - size * 0.04, embY + size * 0.06);
  ctx.stroke();
  // Tiger ears
  ctx.beginPath();
  ...
  for (let s = 0; s < 3; s++) {
    ...
    ctx.quadraticCurveTo(cx - size * 0.035, sy + size * 0.01, cx - size * 0.025, sy + size * 0.018);
    ctx.stroke();
    ctx.beginPath();
    ctx.moveTo(cx + size * 0.02, sy);
    ctx.quadraticCurveTo(cx + size * 0.035, sy + size * 0.01, cx + size * 0.025, sy + size * 0.018);
  ...
  for (const side of [-1, 1]) {
    ctx.beginPath();
    ctx.arc(cx + side * size * 0.08, embY, size * 0.045, side > 0 ? Math.PI * 0.6 : -Math.PI * 0.4, side > 0 ? Math.PI * 1.4 : Math.PI * 0.4);
    ctx.stroke();
    for (let l = 0; l < 4; l++) {
      const la = (side > 0 ? Math.PI * 0.6 : -Math.PI * 0.4) + l * 0.2 * (side > 0 ? 1 : 1.8);
  ...
  ctx.quadraticCurveTo(cx, y + size * 0.2, cx + size * 0.1, y - size * 0.12 - bodyBob);
  ctx.closePath();
  ctx.fill();
  ...
  for (let f = 0; f < 4; f++) {
    ...
    ctx.quadraticCurveTo(cx + fOff + fWave * 1.5, y + size * 0.04, cx + fOff + fWave * 0.5, y + size * 0.22);
    ctx.stroke();
  }

  // ── Shoulder mantle / capelet (over cape, under armor) ──
  const mantleGrad = ctx.createLinearGradient(cx - size * 0.25, y - size * 0.38, cx + size * 0.25, y - size * 0.2);
  ...
  ctx.quadraticCurveTo(cx - size * 0.32 + capeWave3, y - size * 0.28, cx - size * 0.28, y - size * 0.16 - bodyBob);
  for (let t = 0; t < 6; t++) {
  ...
  ctx.quadraticCurveTo(cx + size * 0.32 + capeWave3, y - size * 0.28, cx + size * 0.18, y - size * 0.36 - bodyBob);
  ctx.closePath();
  ctx.fill();
  // Mantle gold trim
  ctx.strokeStyle = goldBright;
  ...
  for (let d = 0; d < 8; d++) {
    ...
    const dy = y - size * 0.17 + Math.sin(time * 2.8 + d * 1.1) * size * 0.006 - bodyBob;
    ctx.beginPath();
  ...
  const plateGrad = ctx.createLinearGradient(cx - size * 0.14, y - size * 0.35, cx + size * 0.14, y + size * 0.02);
  ...
  ctx.quadraticCurveTo(cx - size * 0.17, y - size * 0.12 - bodyBob, cx - size * 0.13, y + size * 0.02 - bodyBob);
  ctx.lineTo(cx + size * 0.13, y + size * 0.02 - bodyBob);
  ctx.quadraticCurveTo(cx + size * 0.17, y - size * 0.12 - bodyBob, cx + size * 0.14, y - size * 0.34 - bodyBob);
  ctx.closePath();
  ctx.fill();
  ...
  ctx.quadraticCurveTo(cx - size * 0.02, y - size * 0.15 - bodyBob, cx - size * 0.06, y - size * 0.02 - bodyBob);
  ctx.lineTo(cx - size * 0.01, y - size * 0.02 - bodyBob);
  ctx.quadraticCurveTo(cx + size * 0.01, y - size * 0.15 - bodyBob, cx + size * 0.02, y - size * 0.32 - bodyBob);
  ctx.closePath();
  ctx.fill();
  ...
  ctx.quadraticCurveTo(cx - size * 0.06, y - size * 0.18 - bodyBob, cx - size * 0.04, y - size * 0.26 - bodyBob);
  ctx.stroke();
  ctx.beginPath();
  ctx.moveTo(cx, y - size * 0.12 - bodyBob);
  ctx.quadraticCurveTo(cx + size * 0.06, y - size * 0.18 - bodyBob, cx + size * 0.04, y - size * 0.26 - bodyBob);
  ...
  ctx.beginPath();
  ctx.roundRect(cx + size * 0.1, y - size * 0.04 - bodyBob, size * 0.015, size * 0.06, size * 0.003);
  ctx.fill();
  ctx.fillStyle = gold;
  ctx.beginPath();
  ctx.roundRect(cx + size * 0.097, y - size * 0.045 - bodyBob, size * 0.02, size * 0.008, size * 0.002);
  ctx.fill();
  ...
  ctx.lineWidth = 0.8 * zoom;
  ctx.strokeRect(cx - size * 0.14, y - size * 0.03 - bodyBob, size * 0.28, size * 0.03);
  setShadowBlur(ctx, 2 * zoom, gold);
  ctx.fillStyle = goldBright;
  ctx.beginPath();
  ctx.roundRect(cx - size * 0.025, y - size * 0.035 - bodyBob, size * 0.05, size * 0.04, size * 0.005);
  ctx.fill();
  clearShadow(ctx);
  ...
  for (const side of [-1, 1]) {
    ...
    const epGrad = ctx.createLinearGradient(spx - size * 0.05, spy, spx + size * 0.05, spy + size * 0.04);
    ...
    ctx.beginPath();
    ctx.ellipse(spx + side * size * 0.01, spy + size * 0.015, size * 0.055, size * 0.025, side * 0.2, 0, TAU);
    ctx.fill();
    ctx.strokeStyle = goldDark;
    ctx.lineWidth = 1 * zoom;
    ctx.stroke();
    ...
    ctx.beginPath();
    ctx.arc(spx + side * size * 0.01, spy + size * 0.025, size * 0.04, 0.2, Math.PI - 0.2);
    ctx.stroke();
    for (let t = 0; t < 5; t++) {
      const tx = spx + side * size * (-0.03 + t * 0.015);
      const tLen = size * (0.04 + (t % 2) * 0.015) + Math.sin(time * 2.5 + t) * size * 0.005;
      ctx.strokeStyle = goldBright;
      ctx.lineWidth = 1.2 * zoom;
      ctx.beginPath();
      ctx.moveTo(tx, spy + size * 0.035);
      ctx.lineTo(tx + Math.sin(time * 1.8 + t * 0.6) * size * 0.004, spy + size * 0.035 + tLen);
      ctx.stroke();
      ctx.fillStyle = gold;
      ctx.beginPath();
      ctx.arc(tx + Math.sin(time * 1.8 + t * 0.6) * size * 0.004, spy + size * 0.038 + tLen, size * 0.003, 0, TAU);
      ctx.fill();
    }
  }
  ...
  drawPathArm(ctx, cx + size * 0.15, y - size * 0.3 - bodyBob, size, time, zoom, 1, {
    color: crimsonDark,
    colorDark: "#1e0338",
    handColor: ivory,
    upperLen: 0.15,
    foreLen: drawForeLen,
    width: 0.048,
    shoulderAngle: (0.8 + Math.sin(time * 1.2) * 0.02) + (isAttacking ? attackIntensity * 0.4 : 0),
    elbowAngle: (1.0 + (isAttacking ? attackIntensity * 0.3 : 0)),
    style: "fleshy",
    onWeapon: (wCtx) => {
      ...
      for (let k = 0; k < 3; k++) {
        ...
        wCtx.beginPath();
        wCtx.roundRect(-tabW * 0.7, ky, tabW * 1.4, tabH * 0.12, size * 0.002);
        wCtx.fill();
      }
      wCtx.fillStyle = gold;
      wCtx.beginPath();
      ...
      const stringAlpha = 0.85 + (isAttacking ? attackIntensity * 0.15 : Math.sin(time * 2) * 0.1);
      ...
      for (let f = 0; f < 3; f++) {
        ...
        wCtx.quadraticCurveTo(fOff + size * 0.008, tabH * 0.05, fOff, -size * 0.01);
        wCtx.quadraticCurveTo(fOff - size * 0.004, tabH * 0.05, fOff, tabH * 0.2);
        wCtx.fill();
      }
  ...
  drawPathArm(ctx, cx - size * 0.15, y - size * 0.3 - bodyBob, size, time, zoom, -1, {
    ...
    foreLen: bowForeLen,
    width: 0.048,
    shoulderAngle: (1.25 + (isAttacking ? attackIntensity * 0.15 : 0)) + Math.sin(time * 1.5) * 0.02,
    ...
    onWeapon: (wCtx) => {
      ...
      wCtx.bezierCurveTo(uOC1x, uOC1y - halfTip * 0.7, uOC2x, uOC2y - halfBase * 0.85, uHandleX, uHandleY - halfBase);
      wCtx.lineTo(uHandleX, uHandleY + halfBase);
      wCtx.bezierCurveTo(uIC2x, uIC2y + halfBase * 0.85, uIC1x, uIC1y + halfTip * 0.7, uTipX, uTipY + halfTip);
      wCtx.closePath();
      wCtx.fill();
      ...
      wCtx.bezierCurveTo(lOC1x, lOC1y - halfBase * 0.85, lOC2x, lOC2y - halfTip * 0.7, lTipX, lTipY - halfTip);
      wCtx.lineTo(lTipX, lTipY + halfTip);
      wCtx.bezierCurveTo(lOC2x, lOC2y + halfTip * 0.7, lOC1x, lOC1y + halfBase * 0.85, lHandleX, lHandleY + halfBase);
      wCtx.closePath();
      wCtx.fill();
      ...
      for (const sp of sinewPositions) {
        const t = sp;
        const t2 = 1 - t;
        const sxOuter = t2 * t2 * t2 * uTipX + 3 * t2 * t2 * t * uOC1x + 3 * t2 * t * t * uOC2x + t * t * t * uHandleX;
      ...
      for (const sp of sinewPositions) {
        const t = sp;
        const t2 = 1 - t;
        const sxOuter = t2 * t2 * t2 * lHandleX + 3 * t2 * t2 * t * lOC1x + 3 * t2 * t * t * lOC2x + t * t * t * lTipX;
        const syOuter = t2 * t2 * t2 * lHandleY + 3 * t2 * t2 * t * lOC1y + 3 * t2 * t * t * lOC2y + t * t * t * lTipY;
      ...
      for (let g = 0; g < 2; g++) {
        ...
        wCtx.bezierCurveTo(-size * 0.095 + gOff, bowH * 0.16, -size * 0.055 + gOff, bowH * 0.36, size * 0.02 + gOff, bowH * 0.48);
        wCtx.stroke();
      }
      ...
      for (const dir of [-1, 1]) {
        ...
        wCtx.fillStyle = goldBright;
        wCtx.beginPath();
        wCtx.arc(size * 0.06, tipY + dir * size * 0.005, size * 0.005, 0, TAU);
        wCtx.fill();
        clearShadow(wCtx);
      }
      ...
      wCtx.beginPath();
      wCtx.roundRect(-size * 0.075, gripY - gripH / 2, size * 0.045, gripH, size * 0.006);
      wCtx.fill();
      wCtx.strokeStyle = goldDark;
      wCtx.lineWidth = 0.8 * zoom;
      wCtx.stroke();
      ...
      for (let t = 0; t < 3; t++) {
        ...
        wCtx.lineTo(tBaseX + Math.sin(time * 1.5 + t) * size * 0.006, tasselBase + tLen);
        wCtx.stroke();
        wCtx.fillStyle = goldBright;
        wCtx.beginPath();
        wCtx.arc(tBaseX + Math.sin(time * 1.5 + t) * size * 0.006, tasselBase + tLen + size * 0.003, size * 0.003, 0, TAU);
        wCtx.fill();
      }

      // Arrow rest/shelf
      wCtx.fillStyle = gold;
      wCtx.fillRect(-size * 0.07, gripY - size * 0.005, size * 0.03, size * 0.01);

      // Bowstring — proper catenary with strong pull animation
      const idleDraw = size * 0.05 + Math.sin(time * 1.5) * size * 0.012;
      const stringTwang = isAttacking && attackIntensity < 0.3 ? Math.sin(time * 35) * size * 0.015 * (1 - attackIntensity * 3) : 0;
      const stringPull = isAttacking ? attackIntensity * size * 0.2 + stringTwang : idleDraw;
      wCtx.strokeStyle = "#ede8d0";
      wCtx.lineWidth = 1.5 * zoom;
      wCtx.beginPath();
      wCtx.moveTo(size * 0.06, -bowH * 0.495);
      wCtx.quadraticCurveTo(stringPull - size * 0.04, 0, size * 0.06, bowH * 0.495);
      wCtx.stroke();
      // Bright inner core
      ...
      wCtx.quadraticCurveTo(stringPull - size * 0.04, 0, size * 0.06, bowH * 0.49);
      wCtx.stroke();
  ...
  for (const side of [-1, 1]) {
    ...
    ctx.beginPath();
    ctx.ellipse(headX + side * size * 0.045, headY - size * 0.01, size * 0.02, size * 0.012, 0, 0, TAU);
    ctx.fill();
    ctx.fillStyle = "#2a1a08";
    ctx.beginPath();
    ctx.arc(headX + side * size * 0.045, headY - size * 0.01, size * 0.009, 0, TAU);
    ctx.fill();
    ctx.fillStyle = goldBright;
    ctx.beginPath();
    ctx.arc(headX + side * size * 0.043, headY - size * 0.013, size * 0.003, 0, TAU);
    ctx.fill();
  ...
  ctx.quadraticCurveTo(headX, headY + size * 0.04, headX + size * 0.025, headY + size * 0.045);
  ctx.stroke();
  // Jawline shadow
  ...
  const neckGrad = ctx.createLinearGradient(headX, headY, headX, headY + size * 0.1);
  ...
  const skullGrad = ctx.createRadialGradient(headX - size * 0.02, headY - size * 0.08, 0, headX, headY - size * 0.04, size * 0.28);
  ...
  ctx.quadraticCurveTo(headX - size * 0.26, headY - size * 0.04, headX - size * 0.2, headY - size * 0.12);
  ctx.quadraticCurveTo(headX - size * 0.14, headY - size * 0.2, headX - size * 0.05, headY - size * 0.22);
  ctx.quadraticCurveTo(headX, headY - size * 0.23, headX + size * 0.05, headY - size * 0.22);
  ctx.quadraticCurveTo(headX + size * 0.14, headY - size * 0.2, headX + size * 0.2, headY - size * 0.12);
  ctx.quadraticCurveTo(headX + size * 0.26, headY - size * 0.04, headX + size * 0.22, headY + size * 0.02);
  ctx.quadraticCurveTo(headX + size * 0.14, headY + size * 0.05, headX, headY + size * 0.04);
  ctx.quadraticCurveTo(headX - size * 0.14, headY + size * 0.05, headX - size * 0.22, headY + size * 0.02);
  ctx.fill();
  ...
  ctx.quadraticCurveTo(headX - size * 0.08, headY - size * 0.1, headX - size * 0.1, headY + size * 0.01);
  ctx.lineTo(headX - size * 0.04, headY + size * 0.01);
  ctx.quadraticCurveTo(headX - size * 0.03, headY - size * 0.1, headX - size * 0.02, headY - size * 0.2);
  ctx.closePath();
  ctx.fill();

  // Raised comb/ridge along top center of skull
  const combGrad = ctx.createLinearGradient(headX - size * 0.02, headY, headX + size * 0.02, headY);
  ...
  ctx.quadraticCurveTo(headX - size * 0.015, headY - size * 0.28, headX, headY - size * 0.3);
  ctx.quadraticCurveTo(headX + size * 0.015, headY - size * 0.28, headX + size * 0.03, headY - size * 0.1);
  ctx.quadraticCurveTo(headX + size * 0.01, headY - size * 0.22, headX, headY - size * 0.24);
  ctx.quadraticCurveTo(headX - size * 0.01, headY - size * 0.22, headX - size * 0.03, headY - size * 0.1);
  ctx.fill();
  ctx.strokeStyle = "rgba(255, 255, 255, 0.3)";
  ctx.lineWidth = 0.6 * zoom;
  ctx.beginPath();
  ctx.moveTo(headX, headY - size * 0.24);
  ctx.quadraticCurveTo(headX - size * 0.012, headY - size * 0.22, headX - size * 0.028, headY - size * 0.1);
  ctx.stroke();

  // Ornate gold-engraved cheek guards / face plate framing the face
  for (const side of [-1, 1]) {
    const cgGrad = ctx.createLinearGradient(headX + side * size * 0.1, headY - size * 0.05, headX + side * size * 0.22, headY + size * 0.06);
    ...
    ctx.quadraticCurveTo(headX + side * size * 0.24, headY - size * 0.02, headX + side * size * 0.22, headY + size * 0.04);
    ctx.quadraticCurveTo(headX + side * size * 0.2, headY + size * 0.08, headX + side * size * 0.14, headY + size * 0.09);
    ctx.quadraticCurveTo(headX + side * size * 0.1, headY + size * 0.07, headX + side * size * 0.12, headY + size * 0.02);
    ctx.quadraticCurveTo(headX + side * size * 0.13, headY - size * 0.03, headX + side * size * 0.15, headY - size * 0.08);
    ctx.fill();
    ctx.strokeStyle = goldDark;
    ctx.lineWidth = 0.8 * zoom;
    ctx.stroke();
    ...
    ctx.quadraticCurveTo(headX + side * size * 0.19, headY + size * 0.01, headX + side * size * 0.17, headY + size * 0.04);
    ctx.stroke();
    ctx.beginPath();
    ctx.moveTo(headX + side * size * 0.15, headY + size * 0.01);
    ctx.quadraticCurveTo(headX + side * size * 0.2, headY + size * 0.03, headX + side * size * 0.16, headY + size * 0.06);
    ctx.stroke();
    ...
    for (const rp of rivetPositions) {
      ...
      ctx.beginPath();
      ctx.arc(headX + side * size * rp.rx, headY + size * rp.ry, size * 0.005, 0, TAU);
      ctx.fill();
      clearShadow(ctx);
    }
  }
  ...
  setShadowBlur(ctx, 3 * zoom, goldBright);
  const browGrad = ctx.createLinearGradient(headX - size * 0.18, headY - size * 0.06, headX + size * 0.18, headY - size * 0.06);
  ...
  ctx.quadraticCurveTo(headX + size * 0.15, headY - size * 0.07, headX, headY - size * 0.08);
  ctx.quadraticCurveTo(headX - size * 0.15, headY - size * 0.07, headX - size * 0.2, headY - size * 0.04);
  ctx.fill();
  clearShadow(ctx);
  ...
  for (const side of [-1, 1]) {
    ctx.beginPath();
    ctx.arc(headX + side * size * 0.06, headY - size * 0.12, size * 0.06, Math.PI * (side > 0 ? 1.2 : -0.2), Math.PI * (side > 0 ? 1.8 : 0.8));
    ctx.stroke();
    for (let l = 0; l < 3; l++) {
  ...
  for (const side of [-1, 1]) {
    for (let s = 0; s < 3; s++) {
      ...
      ctx.quadraticCurveTo(headX + side * size * 0.12, sy + size * 0.015, headX + side * size * 0.1, sy + size * 0.03);
      ctx.stroke();
    }
  }
  ...
  const plumeWave2 = Math.sin(time * 1.8 + 1.0) * 0.08;
  ctx.rotate(plumeWave * 0.25);
  const plumeH = size * 0.48;

  // Back plume layer — wide dramatic sweep
  const backPlumeGrad = ctx.createLinearGradient(-size * 0.06, 0, size * 0.04, -plumeH);
  ...
  ctx.bezierCurveTo(
    ...
    -plumeH * 0.3,
    -size * 0.1 + Math.sin(time * 3.0) * size * 0.025,
    -plumeH * 0.65,
  ...
  ctx.quadraticCurveTo(size * 0.06, -plumeH * 0.45, size * 0.04, -plumeH * 0.15);
  ctx.closePath();
  ctx.fill();
  ...
  ctx.quadraticCurveTo(-size * 0.02, -plumeH * 0.55, -size * 0.01, -plumeH * 0.2);
  ctx.closePath();
  ctx.fill();
  ...
  for (let b = 0; b < 10; b++) {
    const bt = (b + 1) / 11;
    const bx = -size * 0.025 * (1 - bt) + size * 0.04 * bt + Math.sin(time * 3 + b * 0.7) * size * 0.006;
    const by = -plumeH * bt;
    ctx.beginPath();
    ctx.moveTo(bx, by);
  ...
  for (let b = 0; b < 6; b++) {
    const bt = (b + 1) / 7;
    const bx = -size * 0.05 * (1 - bt) + Math.sin(time * 2.6 + b) * size * 0.005;
...
export function drawMageEnemy(
  ...
  const coatWind2 = Math.sin(time * 2.0 + 0.8) * size * 0.006;
  const coatGrad = ctx.createLinearGradient(cx - size * 0.26, y - size * 0.35, cx + size * 0.26, y + size * 0.35);
  ...
  ctx.beginPath();
  ctx.moveTo(cx - size * 0.14, y - size * 0.34 - bodyBob);
  ctx.quadraticCurveTo(cx - size * 0.24, y - size * 0.05 - bodyBob, cx - size * 0.24, y + size * 0.14);
  ctx.quadraticCurveTo(cx - size * 0.25 + coatWind, y + size * 0.19, cx - size * 0.22 + coatWind, y + size * 0.25);
  ctx.quadraticCurveTo(cx - size * 0.18, y + size * 0.22, cx - size * 0.14 + coatWind2, y + size * 0.25);
  ctx.quadraticCurveTo(cx - size * 0.10, y + size * 0.22, cx - size * 0.06 + coatWind, y + size * 0.24);
  ctx.quadraticCurveTo(cx - size * 0.02, y + size * 0.21, cx + size * 0.02 + coatWind2, y + size * 0.23);
  ctx.quadraticCurveTo(cx + size * 0.06, y + size * 0.20, cx + size * 0.10 + coatWind, y + size * 0.22);
  ctx.quadraticCurveTo(cx + size * 0.14, y + size * 0.19, cx + size * 0.18 + coatWind2, y + size * 0.21);
  ctx.quadraticCurveTo(cx + size * 0.22, y + size * 0.16, cx + size * 0.24, y + size * 0.10);
  ctx.quadraticCurveTo(cx + size * 0.24, y - size * 0.05 - bodyBob, cx + size * 0.14, y - size * 0.34 - bodyBob);
  ctx.closePath();
  ctx.fill();

  // Trailing back panel (darker, extends further down)
  const backPanelGrad = ctx.createLinearGradient(cx, y + size * 0.1, cx, y + size * 0.30);
  ...
  ctx.quadraticCurveTo(cx - size * 0.16 + coatWind, y + size * 0.22, cx - size * 0.12 + coatWind2, y + size * 0.28);
  ctx.quadraticCurveTo(cx - size * 0.06, y + size * 0.25, cx + coatWind, y + size * 0.27);
  ctx.quadraticCurveTo(cx + size * 0.06, y + size * 0.25, cx + size * 0.12 - coatWind2, y + size * 0.28);
  ctx.quadraticCurveTo(cx + size * 0.16 - coatWind, y + size * 0.22, cx + size * 0.1, y + size * 0.12);
  ctx.closePath();
  ctx.fill();
  ...
  ctx.quadraticCurveTo(cx - size * 0.24, y + size * 0.05, cx - size * 0.23, y + size * 0.20);
  ctx.stroke();
  ctx.beginPath();
  ctx.moveTo(cx + size * 0.23, y - size * 0.15 - bodyBob);
  ctx.quadraticCurveTo(cx + size * 0.24, y + size * 0.03, cx + size * 0.23, y + size * 0.16);
  ctx.stroke();
  ...
  // High collar flaps
  const collarGrad = ctx.createLinearGradient(cx - size * 0.12, y - size * 0.38, cx + size * 0.12, y - size * 0.32);
  ...
  ctx.quadraticCurveTo(cx - size * 0.1, y - size * 0.42 - bodyBob, cx - size * 0.04, y - size * 0.43 - bodyBob);
  ...
  const beltGrad = ctx.createLinearGradient(cx - size * 0.16, y - size * 0.05, cx + size * 0.16, y - size * 0.05);
  ...
  ctx.beginPath();
  ctx.roundRect(cx - size * 0.02, y - size * 0.06 - bodyBob, size * 0.04, size * 0.04, size * 0.004);
  ctx.fill();
  ...
  for (const side of [-1, 1]) {
    ...
    ctx.beginPath();
    ctx.roundRect(px - size * 0.018, py - size * 0.015, size * 0.036, size * 0.03, size * 0.004);
    ctx.fill();
  ...
  for (const side of [-1, 1]) {
    ...
    const epGrad = ctx.createRadialGradient(epX, epY, 0, epX, epY, size * 0.035);
    ...
    if (bubblePhase > 0) {
      ...
      ctx.beginPath();
      ctx.arc(beakerX, beakerY - size * 0.005 * bubblePhase, size * 0.003, 0, TAU);
      ctx.fill();
    }
  }
  ...
  drawPathArm(ctx, cx - size * 0.2, y - size * 0.28 - bodyBob, size, time, zoom, -1, {
    ...
    foreLen: bookForeLen,
    width: 0.048,
    shoulderAngle: 0.4 + Math.sin(time * 1.0) * 0.03 + (isAttacking ? -attackIntensity * 0.25 : 0),
    ...
    onWeapon: (wCtx) => {
      ...
      wCtx.quadraticCurveTo(-size * (0.006 + Math.sin(time * 3) * 0.002), 0, -size * 0.003, bH - size * 0.005);
      ...
      const sketchCy = 0;
      wCtx.beginPath();
      wCtx.ellipse(sketchCx, sketchCy - size * 0.015, size * 0.015, size * 0.02, 0, 0, TAU);
      wCtx.stroke();
      for (let rib = 0; rib < 3; rib++) {
        const ribY = sketchCy + rib * size * 0.008;
        wCtx.beginPath();
        wCtx.moveTo(sketchCx - size * 0.012, ribY);
        wCtx.quadraticCurveTo(sketchCx, ribY + size * 0.003, sketchCx + size * 0.012, ribY);
        wCtx.stroke();
      }
      wCtx.beginPath();
      ...
      wCtx.quadraticCurveTo(bW + size * 0.03, -bH * 0.3, bW + size * 0.025, bH * 0.1);
      wCtx.stroke();
  ...
  drawPathArm(ctx, cx + size * 0.2, y - size * 0.28 - bodyBob, size, time, zoom, 1, {
    ...
    width: 0.048,
    shoulderAngle: -(0.75 + (isAttacking ? attackIntensity * 0.15 : 0)) + Math.sin(time * 1.3) * 0.02,
    ...
    onWeapon: (wCtx) => {
      ...
      for (let b = 0; b < 4; b++) {
        ...
        const bandGrad = wCtx.createLinearGradient(-size * 0.02, by, size * 0.02, by);
        bandGrad.addColorStop(0, "#8a6818");
        bandGrad.addColorStop(0.5, "#d4aa38");
        bandGrad.addColorStop(1, "#8a6818");
        wCtx.fillStyle = bandGrad;
        wCtx.fillRect(-size * 0.02, by - size * 0.003, size * 0.04, size * 0.006);
      }
      ...
      const orbGrad = wCtx.createRadialGradient(0, orbCy, 0, 0, orbCy, size * 0.04);
      ...
      for (let w = 0; w < 4; w++) {
        ...
        const wR = size * 0.06;
        wCtx.beginPath();
        wCtx.moveTo(Math.cos(wAngle) * size * 0.02, orbCy + Math.sin(wAngle) * size * 0.02);
        wCtx.quadraticCurveTo(
          Math.cos(wAngle + 0.5) * wR, orbCy + Math.sin(wAngle + 0.5) * wR * 0.6,
          Math.cos(wAngle + 1) * wR * 0.8, orbCy + Math.sin(wAngle + 1) * wR * 0.5,
        );
        wCtx.stroke();
      }
    },
  ...
  const maskGrad = ctx.createRadialGradient(headX, headY, 0, headX, headY, size * 0.12);
  ...
  const beakGrad = ctx.createLinearGradient(headX, headY, headX, headY + size * 0.22);
  ...
  ctx.quadraticCurveTo(headX - size * 0.06, headY + size * 0.1, headX, headY + size * 0.2 + Math.sin(time * 2) * size * 0.005);
  ctx.quadraticCurveTo(headX + size * 0.06, headY + size * 0.1, headX + size * 0.05, headY + size * 0.02);
  ctx.closePath();
  ctx.fill();
  ...
  for (const side of [-1, 1]) {
    ...
    const lensGrad = ctx.createRadialGradient(lensX, lensY, 0, lensX, lensY, size * 0.028);
    lensGrad.addColorStop(0, `rgba(150, 255, 200, ${0.7 + alchemyPulse * 0.3})`);
    lensGrad.addColorStop(0.4, `rgba(60, 220, 140, ${0.6 + alchemyPulse * 0.2})`);
  ...
  // Brim
  const brimGrad = ctx.createRadialGradient(headX, hatBaseY, size * 0.05, headX, hatBaseY, size * 0.22);
  ...
  const crownGrad = ctx.createLinearGradient(headX - size * 0.1, hatBaseY, headX + size * 0.1, hatBaseY - size * 0.18);
  ...
  ctx.fillStyle = "#c8a838";
  ctx.beginPath();
  ctx.roundRect(headX - size * 0.015, hatBaseY - size * 0.032, size * 0.03, size * 0.024, size * 0.003);
  ctx.fill();
  ...
  drawArcaneSparkles(ctx, cx, y - size * 0.3, size, time, zoom, { color: "#28c896", count: 6, sparkleSize: 0.015 });
...
export function drawWarlockEnemy(
  ...
  ctx.beginPath();
  ctx.ellipse(cx, y + size * 0.3, size * 0.5, size * 0.5 * ISO_Y_RATIO, 0, 0, TAU);
  ctx.fill();

  // Floor-length back panel (behind everything, trailing cape)
  const backPanelGrad = ctx.createLinearGradient(cx, y - size * 0.3, cx, y + size * 0.48);
  backPanelGrad.addColorStop(0, charcoalDark);
  backPanelGrad.addColorStop(0.6, "#060610");
  backPanelGrad.addColorStop(1, "#030308");
  ctx.fillStyle = backPanelGrad;
  ctx.beginPath();
  ctx.moveTo(cx - size * 0.12, y - size * 0.30 - bodyBob);
  ctx.quadraticCurveTo(cx - size * 0.22, y + size * 0.1, cx - size * 0.24, y + size * 0.44);
  for (let t = 0; t < 10; t++) {
  ...
  ctx.quadraticCurveTo(cx + size * 0.22, y + size * 0.1, cx + size * 0.12, y - size * 0.30 - bodyBob);
  ctx.closePath();
  ctx.fill();
  ...
  for (let t = 0; t < 10; t++) {
    ...
    const ty = y + size * 0.40 + billow + (t % 2) * size * 0.025;
    ctx.lineTo(tx, ty);
  }
  ctx.quadraticCurveTo(cx + size * 0.32, y + size * 0.04, cx + size * 0.22, y - size * 0.34 - bodyBob);
  ctx.closePath();
  ctx.fill();
  ...
  ctx.quadraticCurveTo(cx - size * 0.26, y + size * 0.06, cx - size * 0.23, y + size * 0.36);
  for (let t = 0; t < 8; t++) {
    const tx = cx - size * 0.23 + t * size * 0.066;
    const billow = Math.sin(time * 2.0 + t * 0.9 + 0.5) * size * 0.014;
    const ty = y + size * 0.37 + billow;
    ctx.lineTo(tx, ty);
  }
  ctx.quadraticCurveTo(cx + size * 0.26, y + size * 0.06, cx + size * 0.18, y - size * 0.28 - bodyBob);
  ctx.closePath();
  ctx.fill();
  ...
  ctx.strokeStyle = `rgba(201, 168, 76, ${0.6 + Math.sin(time * 2.0) * 0.15})`;
  ctx.lineWidth = 1.2 * zoom;
  ctx.beginPath();
  for (let t = 0; t < 10; t++) {
  ...
  for (const side of [-1, 1]) {
    ctx.beginPath();
    ctx.moveTo(cx + side * size * 0.04, y - size * 0.30 - bodyBob);
    ctx.quadraticCurveTo(cx + side * size * 0.05, y + size * 0.05, cx + side * size * 0.06, y + size * 0.36);
    ctx.stroke();
  }
  ...
  for (let t = 0; t < 7; t++) {
    ...
    ctx.moveTo(tx, ty);
    for (let s = 0; s < 4; s++) {
      tx += Math.cos(tAngle + Math.sin(time * 2.2 + s * 0.8) * 0.5) * size * 0.055;
      ty += size * 0.035;
      ctx.lineTo(tx, ty);
    }
    ctx.stroke();
  ...
  for (let w = 0; w < 4; w++) {
    ...
    const smokeGrad = ctx.createRadialGradient(wX, y + size * 0.32 - wRise, 0, wX, y + size * 0.32 - wRise, size * 0.04);
    smokeGrad.addColorStop(0, "rgba(76, 29, 149, 0.4)");
    smokeGrad.addColorStop(1, "rgba(0,0,0,0)");
    ctx.fillStyle = smokeGrad;
    ctx.beginPath();
    ctx.ellipse(wX, y + size * 0.32 - wRise, size * 0.04, size * 0.025, 0, 0, TAU);
    ctx.fill();
  }
  ctx.globalAlpha = 1;
  ...
  const suitGrad = ctx.createLinearGradient(cx - size * 0.15, torsoTop, cx + size * 0.15, torsoBot);
  ...
  ctx.quadraticCurveTo(cx - size * 0.18 * breath, y - size * 0.12 - bodyBob, cx - size * 0.13, torsoBot);
  ctx.lineTo(cx + size * 0.13, torsoBot);
  ctx.quadraticCurveTo(cx + size * 0.18 * breath, y - size * 0.12 - bodyBob, cx + size * 0.15, torsoTop);
  ctx.closePath();
  ctx.fill();
  ...
  const vestGrad = ctx.createLinearGradient(cx - size * 0.04, torsoTop, cx + size * 0.04, torsoBot);
  ...
  ctx.quadraticCurveTo(cx - size * 0.035, y - size * 0.15 - bodyBob, cx - size * 0.02, torsoBot - size * 0.02);
  ctx.lineTo(cx + size * 0.02, torsoBot - size * 0.02);
  ctx.quadraticCurveTo(cx + size * 0.035, y - size * 0.15 - bodyBob, cx + size * 0.04, torsoTop + size * 0.03);
  ctx.closePath();
  ctx.fill();
  ...
  for (const side of [-1, 1]) {
    ...
    const padGrad = ctx.createLinearGradient(
      spX - side * size * 0.06, spY, spX + side * size * 0.06, spY + size * 0.04,
    );
  ...
  for (let sc = 0; sc < 3; sc++) {
    ...
    ctx.beginPath();
    ctx.ellipse(scX + scSwing, scY + size * 0.025, size * 0.008, size * 0.004, 0, 0, TAU);
    ctx.fill();
  ...
  drawPathArm(ctx, cx - size * 0.2, y - size * 0.28 - bodyBob, size, time, zoom, -1, {
    ...
    width: 0.048,
    shoulderAngle: 0.35 + Math.sin(time * 1.2) * 0.04 + (isAttacking ? -attackIntensity * 0.3 : 0),
    ...
    onWeapon: (wCtx) => {
      ...
      const topGrad = wCtx.createLinearGradient(-bw * 0.5, -bh * 0.55, bw * 0.5, 0);
      ...
      for (let r = 0; r < 2; r++) {
        ...
        wCtx.lineWidth = 1 * zoom;
        wCtx.beginPath();
        wCtx.ellipse(0, floatOff, bw * 0.6 + r * size * 0.015, bh * 0.4 + r * size * 0.01, 0, 0, TAU);
        wCtx.stroke();
      }
    },
  });
  ...
  drawPathArm(ctx, cx + size * 0.2, y - size * 0.28 - bodyBob, size, time, zoom, 1, {
    ...
    width: 0.048,
    shoulderAngle: -(0.7 + (isAttacking ? attackIntensity * 0.2 : 0)) + Math.sin(time * 1.4) * 0.03,
    elbowAngle: -0.15 + (isAttacking ? -attackIntensity * 0.1 : 0),
    style: "bone",
    onWeapon: (wCtx) => {
      ...
      const headGrad = wCtx.createLinearGradient(-gHeadW, gHeadY, gHeadW, gHeadY);
      ...
      const crystalGrad = wCtx.createRadialGradient(0, gHeadY, 0, 0, gHeadY, gHeadW * 0.6);
      ...
      wCtx.beginPath();
      wCtx.ellipse(size * 0.008, gHeadY - size * 0.008, gHeadW * 0.2, gHeadH * 0.25, -0.4, 0, TAU);
      wCtx.fill();
      ...
      for (let tr = 0; tr < 3; tr++) {
        ...
        wCtx.beginPath();
        wCtx.moveTo(Math.cos(trAngle) * gHeadW * 0.4, gHeadY + Math.sin(trAngle) * gHeadH * 0.4);
        wCtx.quadraticCurveTo(
  ...
  ctx.quadraticCurveTo(headX - size * 0.12, headY + size * 0.02, headX - size * 0.08, headY - size * 0.04);
  ctx.quadraticCurveTo(headX, headY + size * 0.06, headX + size * 0.08, headY - size * 0.04);
  ctx.quadraticCurveTo(headX + size * 0.12, headY + size * 0.02, headX + size * 0.1, headY + size * 0.1);
  ctx.closePath();
  ctx.fill();
  ...
  ctx.moveTo(headX, headY - size * 0.1);
  ctx.bezierCurveTo(
    headX + size * 0.09, headY - size * 0.09,
    headX + size * 0.1, headY + size * 0.02,
    headX + size * 0.07, headY + size * 0.1,
  );
  ctx.quadraticCurveTo(headX, headY + size * 0.12, headX - size * 0.07, headY + size * 0.1);
  ctx.bezierCurveTo(
    headX - size * 0.1, headY + size * 0.02,
    headX - size * 0.09, headY - size * 0.09,
  ...
  const crownGrad = ctx.createLinearGradient(headX, crownBaseY, headX, crownTopY);
  ...
  ctx.strokeStyle = `rgba(201, 168, 76, ${0.5 + Math.sin(time * 2.0) * 0.15})`;
  ...
  const spireTips = [
    { x: headX - size * 0.07, y: crownTopY + size * 0.02, s: 0.7 },
    { x: headX - size * 0.03, y: crownTopY, s: 0.85 },
    { x: headX, y: crownTopY - size * 0.04, s: 1.0 },
    { x: headX + size * 0.03, y: crownTopY, s: 0.85 },
    { x: headX + size * 0.07, y: crownTopY + size * 0.02, s: 0.7 },
  ];
  for (let sp = 0; sp < spireTips.length; sp++) {
    ...
    const spGrad = ctx.createRadialGradient(tip.x, tip.y + size * 0.02, 0, tip.x, tip.y + size * 0.02, crystalR);
  ...
  const crCrystalGrad = ctx.createRadialGradient(
    headX, crownMidY + size * 0.02, 0, headX, crownMidY + size * 0.02, size * 0.025,
  );
  ...
  for (let rc = 0; rc < 5; rc++) {
    const rcPhase = time * 2.0 + rc * TAU / 5;
  ...
  for (let w = 0; w < 5; w++) {
    ...
    ctx.beginPath();
    ctx.arc(headX, crownMidY + size * 0.02, size * 0.04 + w * size * 0.012, wPhase, wPhase + Math.PI * 0.5);
    ctx.stroke();
  }
  ...
  for (const side of [-1, 1]) {
    ...
    const hornGrad = ctx.createLinearGradient(0, 0, side * size * 0.09, -size * 0.22);
    ...
    ctx.beginPath();
    ctx.moveTo(0, 0);
    ctx.quadraticCurveTo(side * size * 0.04, -size * 0.08, side * size * 0.10, -size * 0.16);
    ctx.quadraticCurveTo(side * size * 0.12, -size * 0.20, side * size * 0.14, -size * 0.24);
    ctx.quadraticCurveTo(side * size * 0.07, -size * 0.12, size * 0.005, size * 0.005);
    ctx.closePath();
    ctx.fill();
    ...
    for (let rn = 0; rn < 4; rn++) {
      ...
      const rnPulse = 0.2 + Math.sin(time * 3.0 + rn * 1.5 + side) * 0.3;
  ...
  for (let vs = 0; vs < 4; vs++) {
    ...
    const vsR = size * 0.14 + Math.sin(time * 2.0 + vs * 2.0) * size * 0.015;
    const vsX = headX + Math.cos(vsAngle) * vsR;
    const vsY = crownMidY + Math.sin(vsAngle) * vsR * 0.3 + Math.sin(time * 2.5 + vs) * size * 0.01;
    const vsAlpha = 0.4 + Math.sin(time * 3.0 + vs * 1.8) * 0.25;
    ctx.save();
  ...
  for (let sc = 0; sc < 3; sc++) {
    ...
    const scY = y - size * 0.15 + Math.sin(scAngle) * scR * 0.3 + Math.sin(time * 2 + sc) * size * 0.02;
...
export function drawCrossbowmanEnemy(
  ...
  drawPathArm(ctx, cx + size * 0.26, y - size * 0.26 - bodyBob, size, time, zoom, 1, {
    ...
    width: 0.065,
    shoulderAngle: -(0.5 + Math.sin(time * 1.0) * 0.02) - (isAttacking ? attackIntensity * 0.4 : 0),
    ...
    onWeapon: (wCtx) => {
      ...
      const stringTension = isAttacking ? attackIntensity * size * 0.1 : size * 0.025 + Math.sin(time * 1.5) * size * 0.006;
      wCtx.strokeStyle = `rgba(230, 222, 195, ${0.9 + (isAttacking ? 0.1 : 0)})`;
      wCtx.lineWidth = 1.5 * zoom;
      wCtx.beginPath();
      wCtx.moveTo(-size * 0.08, gripH * 0.4);
      wCtx.lineTo(0, gripH * 1.0 + stringTension);
  ...
  drawPathArm(ctx, cx - size * 0.26, y - size * 0.26 - bodyBob, size, time, zoom, -1, {
    ...
    foreLen: xbowForeLen,
    width: 0.065,
    shoulderAngle: -(0.85 + (isAttacking ? attackIntensity * 0.2 : 0)) - Math.sin(time * 1.2) * 0.02,
    elbowAngle: -(0.15 + (isAttacking ? attackIntensity * 0.1 : 0)),
    style: "armored",
    onWeapon: (wCtx) => {
      ...
      const boltVibrate = isAttacking ? Math.sin(time * 30) * size * 0.002 : 0;
      const stringPull = isAttacking ? attackIntensity * size * 0.05 : 0;
      const stringVibrate = isAttacking && attackIntensity < 0.3 ? Math.sin(time * 40) * size * 0.004 : 0;
      ...
      const inlayPositions = [-size * 0.04, -size * 0.10, -size * 0.16];
      ...
      wCtx.fillRect(-railOff, -tillerLen * 0.98, railOff * 2, tillerLen * 0.97);
      ...
      wCtx.quadraticCurveTo(-size * 0.02, -tillerLen - size * 0.035, 0, -tillerLen - size * 0.038);
      wCtx.quadraticCurveTo(size * 0.02, -tillerLen - size * 0.035, size * 0.025, -tillerLen - size * 0.015);
      ...
      wCtx.quadraticCurveTo(-size * 0.014, -tillerLen - size * 0.03, 0, -tillerLen - size * 0.033);
      wCtx.quadraticCurveTo(size * 0.014, -tillerLen - size * 0.03, size * 0.016, -tillerLen - size * 0.01);
      wCtx.stroke();
      wCtx.lineCap = "butt";
      ...
      const prodGrad = wCtx.createLinearGradient(0, prodY - size * 0.015, 0, prodY + size * 0.015);
      ...
      wCtx.moveTo(0, prodY);
      wCtx.bezierCurveTo(
        -prodSpan * 0.25, prodY + size * 0.008,
        -prodSpan * 0.6, prodY - size * 0.018,
        -prodSpan * 0.85, prodY + size * 0.005,
      );
      wCtx.bezierCurveTo(
        -prodSpan * 0.92, prodY + size * 0.012,
        -prodSpan * 0.97, prodY - size * 0.005,
        -prodSpan, prodY - size * 0.012,
      );
      wCtx.stroke();
      ...
      wCtx.moveTo(0, prodY);
      wCtx.bezierCurveTo(
        -prodSpan * 0.25, prodY + size * 0.006,
        -prodSpan * 0.6, prodY - size * 0.02,
        -prodSpan * 0.85, prodY + size * 0.003,
      );
      wCtx.bezierCurveTo(
        -prodSpan * 0.92, prodY + size * 0.01,
        -prodSpan * 0.97, prodY - size * 0.007,
        -prodSpan, prodY - size * 0.014,
      );
      wCtx.stroke();
      wCtx.beginPath();
      wCtx.moveTo(0, prodY);
      ...
      for (const side of [-1, 1] as const) {
        ...
        for (let w = 0; w < wispCount; w++) {
          ...
          const wy = prodY + Math.sin(t * Math.PI) * size * -0.01 + Math.sin(time * 4 + w * 2) * size * 0.004;
      ...
      const xbowStringPull = isAttacking ? attackIntensity * size * 0.2 + stringVibrate : idleTension;
      wCtx.strokeStyle = "#ede8d0";
      wCtx.lineWidth = 1.5 * zoom;
      wCtx.beginPath();
      wCtx.moveTo(-prodSpan, limbTipY);
      wCtx.quadraticCurveTo(0, limbTipY + size * 0.02 + xbowStringPull, prodSpan, limbTipY);
      wCtx.stroke();
      ...
      wCtx.quadraticCurveTo(0, limbTipY + size * 0.02 + xbowStringPull, prodSpan * 0.95, limbTipY);
      wCtx.stroke();
      ...
      wCtx.quadraticCurveTo(size * 0.02, size * 0.02, size * 0.008, size * 0.035);
      wCtx.stroke();
      ...
      for (const fx of [-1, 1] as const) {
        ...
        wCtx.beginPath();
        wCtx.moveTo(boltVibrate, boltStartY);
        wCtx.lineTo(boltVibrate + fx * size * 0.01, boltStartY + size * 0.015);
...
export function drawHexerEnemy(
  ...
  for (let p = 0; p < 8; p++) {
    const petalT = (time * 0.6 + p * 1.37) % 4.0;
    const petalX = cx + Math.sin(time * 0.8 + p * 2.1) * size * 0.35 + Math.cos(time * 1.3 + p) * size * 0.08;
    const petalY = y - size * 0.5 + petalT * size * 0.25;
    const petalAlpha = petalT < 0.3 ? petalT / 0.3 : petalT > 3.5 ? (4.0 - petalT) / 0.5 : 0.6;
  ...
  for (let sc = 0; sc <= 6; sc++) {
    const t = sc / 6;
    const scX = cx - capeSpread + t * capeSpread * 2 + Math.sin(windPhase * 1.3 + sc * 1.1) * size * 0.015;
    const scY = capeTopY + capeLen + Math.sin(windPhase * 1.5 + sc * 0.9) * size * 0.018;
  ...
  ctx.quadraticCurveTo(
    cx - capeSpread * 0.45, capeTopY + capeLen * 0.4,
    cx - capeSpread * 0.65 + Math.sin(windPhase) * size * 0.02, capeTopY + capeLen * 0.82,
  );
  ctx.lineTo(cx + capeSpread * 0.65 + Math.sin(windPhase + 1) * size * 0.02, capeTopY + capeLen * 0.82);
  ctx.quadraticCurveTo(
    cx + capeSpread * 0.45, capeTopY + capeLen * 0.4,
    cx + size * 0.08, capeTopY + size * 0.02,
  );
  ctx.closePath();
  ctx.fill();
  ...
  ctx.quadraticCurveTo(
    cx + capeSpread * 0.7, capeTopY + capeLen * 0.35,
    cx + capeSpread + Math.sin(windPhase + 1) * size * 0.03, capeTopY + capeLen * 0.88,
  );
  ctx.stroke();
  ...
  for (let rs = 0; rs < 5; rs++) {
    ...
    ctx.beginPath();
    ctx.moveTo(rsX, rsY);
    ctx.quadraticCurveTo(rsX + rsWind * 0.6, rsY + rsLen * 0.5, rsX + rsWind, rsY + rsLen);
    ctx.stroke();
    ctx.lineCap = "butt";
  }
  ctx.restore();
  ...
  for (const side of [-1, 1]) {
    const hakamaGrad = ctx.createLinearGradient(
      cx + side * size * 0.02, y - size * 0.06,
      cx + side * size * 0.15, y + size * 0.2,
    );
  ...
  const kimonoGrad = ctx.createLinearGradient(cx - size * 0.16, y - size * 0.34, cx + size * 0.16, y - size * 0.06);
  ...
  ctx.quadraticCurveTo(cx - size * 0.19, y - size * 0.18 - bodyBob, cx - size * 0.14, y - size * 0.06 - bodyBob);
  ctx.lineTo(cx + size * 0.14, y - size * 0.06 - bodyBob);
  ctx.quadraticCurveTo(cx + size * 0.19, y - size * 0.18 - bodyBob, cx + size * 0.15, y - size * 0.34 - bodyBob);
  ctx.closePath();
  ctx.fill();
  ...
  for (const side of [-1, 1]) {
    ...
    const panelGrad = ctx.createLinearGradient(
      cx + side * size * 0.14, y - size * 0.28,
      cx + side * size * 0.22, y - size * 0.04,
    );
    ...
    ctx.quadraticCurveTo(
      ...
      cx + side * (size * 0.18 + panelWave * 3) + panelWave, y - size * 0.04 - bodyBob,
    );
    ctx.lineTo(cx + side * size * 0.13, y - size * 0.06 - bodyBob);
    ctx.quadraticCurveTo(
      cx + side * size * 0.15, y - size * 0.18 - bodyBob,
      cx + side * size * 0.14, y - size * 0.28 - bodyBob,
    );
    ctx.closePath();
    ctx.fill();
  }
  ...
  ctx.quadraticCurveTo(cx + size * 0.02, y - size * 0.22 - bodyBob, cx - size * 0.01, y - size * 0.16 - bodyBob);
  ctx.quadraticCurveTo(cx + size * 0.05, y - size * 0.12 - bodyBob, cx + size * 0.02, y - size * 0.08 - bodyBob);
  ctx.stroke();
  ctx.beginPath();
  ctx.moveTo(cx + size * 0.04, y - size * 0.26 - bodyBob);
  ctx.quadraticCurveTo(cx - size * 0.01, y - size * 0.2 - bodyBob, cx + size * 0.03, y - size * 0.14 - bodyBob);
  ctx.stroke();

  // Armored obi sash at waist — wide with layered steel plates
  const obiGrad = ctx.createLinearGradient(cx - size * 0.16, y - size * 0.1, cx + size * 0.16, y - size * 0.04);
  ...
  ctx.beginPath();
  ctx.ellipse(cx + size * 0.14, y - size * 0.07 - bodyBob, size * 0.025, size * 0.03, 0.3, 0, TAU);
  ctx.fill();
  ...
  for (const side of [-1, 1]) {
    ...
    const craneGrad = ctx.createLinearGradient(px - size * 0.03, py, px + size * 0.03, py + size * 0.03);
    ...
    for (let t = 0; t < 2; t++) {
      ...
      ctx.strokeStyle = t === 0 ? "rgba(180, 20, 60, 0.7)" : "rgba(212, 175, 55, 0.6)";
      ctx.lineWidth = 1 * zoom;
      ctx.lineCap = "round";
      ctx.beginPath();
      ctx.moveTo(tx, py + size * 0.025);
      ctx.quadraticCurveTo(
        tx + tasselWave, py + size * 0.055,
        tx + tasselWave * 1.3, py + size * 0.075,
      );
      ctx.stroke();
      ctx.lineCap = "butt";
    }
  ...
  drawPathArm(ctx, cx - size * 0.18, y - size * 0.28 - bodyBob, size, time, zoom, -1, {
    ...
    foreLen: fanForeLen,
    width: 0.042,
    shoulderAngle: 0.35 + Math.sin(time * 1.3) * 0.04 + (isAttacking ? -attackIntensity * 0.25 : 0),
    ...
    onWeapon: (wCtx) => {
      ...
      for (let r = 0; r < fanRibs; r++) {
        const ribAngle = -fanSpread + (r / (fanRibs - 1)) * fanSpread * 2 - Math.PI / 2;
      ...
      for (let p = 0; p < fanRibs - 1; p++) {
        const a1 = -fanSpread + (p / (fanRibs - 1)) * fanSpread * 2 - Math.PI / 2;
        const a2 = -fanSpread + ((p + 1) / (fanRibs - 1)) * fanSpread * 2 - Math.PI / 2;
      ...
      for (let b = 0; b < 4; b++) {
        ...
        wCtx.beginPath();
        wCtx.arc(Math.cos(bAngle) * bDist, fanCY + Math.sin(bAngle) * bDist, size * 0.004, 0, TAU);
        wCtx.fill();
      }
      clearShadow(wCtx);
      ...
      if (isAttacking) {
        ...
        wCtx.lineWidth = 1.5 * zoom;
        wCtx.beginPath();
        wCtx.arc(0, fanCY, fanR * 1.15, -fanSpread - Math.PI / 2, fanSpread - Math.PI / 2);
        wCtx.stroke();
      }
    },
  });
  ...
  drawPathArm(ctx, cx + size * 0.18, y - size * 0.28 - bodyBob, size, time, zoom, 1, {
    ...
    onWeapon: (wCtx) => {
      ...
      const shaftGrad = wCtx.createLinearGradient(-size * 0.01, 0, size * 0.01, 0);
      ...
      const tsubaGrad = wCtx.createLinearGradient(-size * 0.025, tsubaY, size * 0.025, tsubaY);
      ...
      const collarGrad = wCtx.createLinearGradient(-size * 0.015, -shaftH, size * 0.015, -shaftH);
      ...
      wCtx.fillRect(-size * 0.012, -shaftH - size * 0.008, size * 0.024, size * 0.016);

      // Crescent blade shape
      setShadowBlur(wCtx, 8 * zoom, "#ff40a0");
      const bladeGrad = wCtx.createLinearGradient(0, bladeY, 0, bladeY - bladeH);
      ...
      wCtx.quadraticCurveTo(-bladeW * 0.4, bladeY - bladeH * 0.3, -bladeW, bladeY - bladeH * 0.7);
      wCtx.quadraticCurveTo(-bladeW * 0.8, bladeY - bladeH * 1.1, 0, bladeY - bladeH);
      wCtx.quadraticCurveTo(bladeW * 0.8, bladeY - bladeH * 1.1, bladeW, bladeY - bladeH * 0.7);
      ...
      wCtx.quadraticCurveTo(-bladeW * 0.25, bladeY - bladeH * 0.4, -bladeW * 0.5, bladeY - bladeH * 0.65);
      wCtx.quadraticCurveTo(-bladeW * 0.3, bladeY - bladeH * 0.85, 0, bladeY - bladeH * 0.75);
      wCtx.quadraticCurveTo(bladeW * 0.3, bladeY - bladeH * 0.85, bladeW * 0.5, bladeY - bladeH * 0.65);
      wCtx.quadraticCurveTo(bladeW * 0.25, bladeY - bladeH * 0.4, 0, bladeY - bladeH * 0.15);
      wCtx.closePath();
      wCtx.fill();
      clearShadow(wCtx);
  ...
  for (const side of [-1, 1]) {
    ...
    const veilGrad = ctx.createLinearGradient(veilX, veilY, veilX + veilWind, veilY + veilLen);
    ...
    ctx.quadraticCurveTo(
      veilX + side * size * 0.06 + veilWind * 0.4, veilY + veilLen * 0.3,
      veilX + side * size * 0.04 + veilWind, veilY + veilLen * 0.65,
    );
    ctx.quadraticCurveTo(
      veilX + side * size * 0.02 + veilWind * 1.3, veilY + veilLen * 0.85,
      veilX + veilWind * 1.5, veilY + veilLen,
    );
    ctx.lineTo(veilX - side * size * 0.02, veilY + veilLen * 0.9);
    ctx.quadraticCurveTo(veilX - side * size * 0.01, veilY + veilLen * 0.5, veilX, veilY);
    ctx.closePath();
    ctx.fill();
  ...
  for (const side of [-1, 1]) {
    ...
    ctx.quadraticCurveTo(
      ...
      headX + side * size * 0.07, headY + size * 0.06,
    );
    ctx.quadraticCurveTo(
      headX + side * size * 0.04, headY + size * 0.03,
      headX + side * size * 0.02, headY - size * 0.06,
    );
    ctx.closePath();
    ctx.fill();
  }
  ...
  for (const side of [-1, 1]) {
    ctx.fillStyle = "#fff";
    ctx.beginPath();
    ctx.ellipse(headX + side * size * 0.035, headY - size * 0.015, size * 0.018, size * 0.012, side * 0.1, 0, TAU);
    ctx.fill();
  ...
  for (const side of [-1, 1]) {
    for (let wm = 0; wm < 2; wm++) {
      ctx.beginPath();
      ctx.moveTo(headX + side * size * 0.02, headY + size * 0.005 + wm * size * 0.012);
  ...
  ctx.beginPath();
  ctx.ellipse(headX, headY + size * 0.04, size * 0.016, size * 0.006, 0, 0, TAU);
  ctx.fill();
  ...
  const crownBandGrad = ctx.createLinearGradient(headX - size * 0.14, crownBaseY, headX + size * 0.14, crownBaseY);
  ...
  ctx.quadraticCurveTo(headX - size * 0.14, crownBaseY - size * 0.01, headX - size * 0.12, crownBaseY - size * 0.02);
  ctx.lineTo(headX + size * 0.12, crownBaseY - size * 0.02);
  ctx.quadraticCurveTo(headX + size * 0.14, crownBaseY - size * 0.01, headX + size * 0.13, crownBaseY + size * 0.015);
  ctx.closePath();
  ctx.fill();
  // Crown body — rising crimson and gold structure
  const crownGrad = ctx.createLinearGradient(headX, crownBaseY, headX, crownBaseY - crownH);
  ...
  ctx.quadraticCurveTo(headX - size * 0.12, crownBaseY - crownH * 0.4, headX - size * 0.06, crownBaseY - crownH * 0.75);
  ctx.lineTo(headX - size * 0.03, crownBaseY - crownH);
  ctx.lineTo(headX + size * 0.03, crownBaseY - crownH);
  ctx.lineTo(headX + size * 0.06, crownBaseY - crownH * 0.75);
  ctx.quadraticCurveTo(headX + size * 0.12, crownBaseY - crownH * 0.4, headX + size * 0.1, crownBaseY - size * 0.02);
  ctx.closePath();
  ctx.fill();
  ...
  for (const side of [-1, 1]) {
    ...
    ctx.quadraticCurveTo(
      headX + side * size * 0.045, moonY - size * 0.05,
      headX + side * size * 0.04, moonY - size * 0.06,
    );
  ...
  const jewelData = [
    { dx: -0.05, frac: 0.35, color: "#ff2060" },
    { dx: 0.05, frac: 0.35, color: "#ff2060" },
    { dx: 0, frac: 0.6, color: "#d4a040" },
    { dx: -0.03, frac: 0.8, color: "#ff60a0" },
    { dx: 0.03, frac: 0.8, color: "#ff60a0" },
  ];
  ...
  for (const side of [-1, 1]) {
    const wingGrad = ctx.createLinearGradient(
      headX + side * size * 0.1, crownBaseY,
      headX + side * size * 0.2, crownBaseY - crownH * 0.5,
    );
    ...
    ctx.quadraticCurveTo(
      headX + side * size * 0.18, crownBaseY - crownH * 0.3,
      headX + side * size * 0.2, crownBaseY - crownH * 0.55,
    );
    ctx.lineTo(headX + side * size * 0.17, crownBaseY - crownH * 0.45);
    ctx.quadraticCurveTo(
      headX + side * size * 0.14, crownBaseY - crownH * 0.2,
      headX + side * size * 0.1, crownBaseY - size * 0.01,
    );
    ctx.closePath();
    ctx.fill();
