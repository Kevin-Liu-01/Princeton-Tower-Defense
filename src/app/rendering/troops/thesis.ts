...
export function drawThesisTroop(
  ...
  const poolGrad = ctx.createRadialGradient(x, y + size * 0.42, 0, x, y + size * 0.42, size * 0.38);
  ...
  // ward aura
  const wardAura = ctx.createRadialGradient(x, y - size * 0.06, 0, x, y - size * 0.06, size * 0.58);
  ...
  const lowerGrad = ctx.createLinearGradient(x, y + size * 0.2, x, y + size * 0.7);
  ...
  ctx.quadraticCurveTo(x - size * 0.28, y + size * 0.42, x - size * 0.12, y + size * 0.62);
  ctx.quadraticCurveTo(x - size * 0.04, y + size * 0.55, x, y + size * 0.68);
  ctx.quadraticCurveTo(x + size * 0.04, y + size * 0.55, x + size * 0.12, y + size * 0.62);
  ctx.quadraticCurveTo(x + size * 0.28, y + size * 0.42, x + size * 0.18, y + size * 0.2);
  ctx.closePath();
  ctx.fill();
  ...
  drawDissolveParticles(ctx, x, y + size * 0.5, size, time, zoom, 8, 0.22, 0.35, "rgba(192, 132, 252, 0.5)", pagePulse);
  ...
  const robeGrad = ctx.createLinearGradient(x - size * 0.24, y - size * 0.32, x + size * 0.24, y + size * 0.44);
  ...
  drawRobeBody(ctx, x, size * 0.16, y - size * 0.28 + hover, size * 0.34, y + size * 0.46, size * 0.36, y + size * 0.03, {
    count: 8,
    amplitude: size * 0.03,
    time,
    speed: 3.4,
  ...
  drawHexEnergyVeins(ctx, x, y + size * 0.08 + hover, size * 0.22, size * 0.38, time, zoom, `rgba(192, 132, 252, ${0.35 + pagePulse * 0.2})`, pagePulse, 4);

  // hex inscription band across waist
  ctx.save();
  ctx.globalAlpha = 0.32 + shimmer * 0.18;
  drawHexChainMail(ctx, x, y + size * 0.05 + hover, size * 0.28, size * 0.06, size * 0.022, `rgba(168, 85, 247, ${0.55 + shimmer * 0.2})`, zoom);
  ctx.globalAlpha = 1;
  ctx.restore();
  ...
  for (let side = -1; side <= 1; side += 2) {
    ...
    ctx.quadraticCurveTo(x + side * size * 0.16, y + size * 0.1, x + side * size * 0.14, y + size * 0.35);
    ctx.stroke();
  }

  // hex armor chest plate
  const chestGrad = ctx.createLinearGradient(x - size * 0.15, y - size * 0.18, x + size * 0.15, y + size * 0.06);
  ...
  drawHexPlate(ctx, x, y - size * 0.06 + hover, size * 0.14, chestGrad, `rgba(192, 132, 252, ${0.5 + shimmer * 0.2})`, 1.2 * zoom);
  ...
  // hex-shaped hood
  const hoodGrad = ctx.createLinearGradient(x - size * 0.13, y - size * 0.42, x + size * 0.13, y - size * 0.18);
  ...
  ctx.quadraticCurveTo(x, y - size * 0.38 + hover * 0.5, x + size * 0.1, y - size * 0.28 + hover * 0.8);
  ctx.stroke();

  // forehead hex rune
  drawGlowingHexGem(ctx, x, y - size * 0.38 + hover * 0.6, size * 0.028, "#c084fc", "#9333ea", pagePulse, zoom);
  ...
  // book body
  const bookGrad = ctx.createLinearGradient(-size * 0.1, 0, size * 0.1, size * 0.14);
  ...
  drawHexPlate(ctx, 0, size * 0.065, size * 0.042, `rgba(139, 92, 246, ${0.6 + shimmer * 0.2})`, `rgba(233, 213, 255, ${0.5 + shimmer * 0.2})`, 0.8 * zoom);
  ...
  // hex corner clasps
  const clasps: [number, number][] = [[-size * 0.07, size * 0.02], [size * 0.07, size * 0.02], [-size * 0.07, size * 0.11], [size * 0.07, size * 0.11]];
  ...
  // orbiting hex runes
  drawOrbitingHexRunes(ctx, x, y - size * 0.12, 5, size * 0.34, 0.35, size * 0.032, `rgba(192, 132, 252, ${0.6 + pagePulse * 0.25})`, time, 1.5, pagePulse, zoom);
