...
> = {
  ...
  ivy_crossroads: {
    ...
    decorations: [
      { type: "nassau_hall", pos: { x: 15, y: 2 }, variant: 0, size: 2.2 },
      ...
      { type: "flowers", pos: { x: 21, y: 6 }, variant: 1 },
  ...
  blight_basin: {
    ...
    decorations: [
      { type: "ruined_temple", pos: { x: 17, y: 6 }, variant: 0, size: 2.5 },
      { type: "sunken_pillar", pos: { x: 8, y: 12 }, variant: 0 },
      { type: "sunken_pillar", pos: { x: 24, y: 22 }, variant: 1 },
      { type: "witch_cottage", pos: { x: 6, y: 7 }, variant: 0, size: 1.2 },
      ...
      { type: "mushroom_cluster", pos: { x: 12, y: 22 }, variant: 1 },
  ...
  sunscorch_labyrinth: {
    ...
    decorations: [
      { type: "giant_sphinx", pos: { x: 16, y: 3 }, variant: 0, size: 1.3 },
  ...
  whiteout_pass: {
    ...
    decorations: [
      { type: "ice_throne", pos: { x: 16, y: 5 }, variant: 0, size: 2.2 },
      { type: "ice_fortress", pos: { x: 5, y: 7 }, variant: 0, size: 1.6 },
      { type: "ice_fortress", pos: { x: 27, y: 7 }, variant: 1, size: 1.6 },
