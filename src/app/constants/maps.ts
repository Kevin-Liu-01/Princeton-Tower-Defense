...
for (const key of Object.keys(MAP_PATHS)) {
  ...
  MAP_PATHS[key] = cornerRadius != null
...
> = {
  ...
  ivy_crossroads: {
    ...
    specialTowers: [
      { pos: { x: 7, y: 20 }, type: "chrono_relay" },
      { pos: { x: 16, y: 11 }, type: "chrono_relay" },
      { pos: { x: 21, y: 16 }, type: "chrono_relay" },
      { pos: { x: 27, y: 10 }, type: "sentinel_nexus" },
    ],
    hazards: [
      { type: "storm_field", pos: { x: 9, y: 14 } },
      { type: "swamp", pos: { x: 9, y: 17 }, radius: 1.8 },
      { type: "poison", pos: { x: 21, y: 18 }, radius: 2.1 },
    ],
    decorations: [
  ...
  blight_basin: {
    ...
    specialTowers: [
      { pos: { x: 7, y: 16 }, type: "shrine" },
      { pos: { x: 22, y: 7 }, type: "vault", hp: 700 },
      { pos: { x: 17, y: 16 }, type: "barracks" },
    ],
    hazards: [
      { type: "poison_fog", pos: { x: 7, y: 14 }, radius: 2.2 },
      { type: "void", pos: { x: 24, y: 19 }, radius: 2.1 },
      { type: "deep_water", pos: { x: 13, y: 11 }, radius: 1.8 },
    ],
    decorations: [
  ...
  sunscorch_labyrinth: {
    ...
    specialTowers: [
      ...
      { pos: { x: 21, y: 21 }, type: "sunforge_orrery" },
      { pos: { x: 14, y: 16 }, type: "chrono_relay" },
      { pos: { x: 11, y: 10 }, type: "sunforge_orrery" },
    ],
    hazards: [
      { type: "quicksand", pos: { x: 14, y: 15 }, radius: 2 },
      { type: "fire", pos: { x: 23, y: 11 }, radius: 2.2 },
      { type: "lightning", pos: { x: 14, y: 17 }, radius: 2.4 },
    ],
    decorations: [
      {
  ...
  whiteout_pass: {
    ...
    specialTowers: [
      { pos: { x: 14, y: 16 }, type: "shrine" },
      { pos: { x: 25, y: 11 }, type: "beacon" },
      { pos: { x: 9, y: 11 }, type: "beacon" },
    ],
    hazards: [
  ...
  cannon_crest: {
    ...
    specialTowers: [
      { pos: { x: 16, y: 20 }, type: "beacon" },
      { pos: { x: 14, y: 11 }, type: "chrono_relay" },
      { pos: { x: 16, y: 16 }, type: "chrono_relay" },
      { pos: { x: 14, y: 8 }, type: "beacon" },
      { pos: { x: 9, y: 3 }, type: "sentinel_nexus" },
      { pos: { x: 20, y: 3 }, type: "sentinel_nexus" },
      { pos: { x: 9, y: 7 }, type: "sentinel_nexus" },
      { pos: { x: 20, y: 9 }, type: "sentinel_nexus" },
    ],
    hazards: [
  ...
  triad_keep: {
    ...
    specialTowers: [
      ...
      { pos: { x: 20, y: 16 }, type: "shrine" },
    ],
    hazards: [
      { type: "poison_fog", pos: { x: 10, y: 13 }, radius: 2.2 },
      { type: "swamp", pos: { x: 18, y: 12 }, radius: 1.8 },
      { type: "void", pos: { x: 29, y: 17 }, radius: 1.7 },
    ],
    decorations: [
  ...
  sun_obelisk: {
    ...
    specialTowers: [
      { pos: { x: 12, y: 5 }, type: "sunforge_orrery" },
      { pos: { x: 24, y: 19 }, type: "beacon", hp: 500 },
      { pos: { x: 16, y: 16 }, type: "chrono_relay" },
      { pos: { x: 7, y: 16 }, type: "sentinel_nexus" },
    ],
    hazards: [
      { type: "quicksand", pos: { x: 14, y: 8 }, radius: 2 },
    ...
    decorations: [
      ...
      { type: "pyramid", pos: { x: 4, y: 4 }, variant: 0, size: 1.5 },
      { type: "pyramid", pos: { x: 28, y: 22 }, variant: 1, size: 1.3 },
      { type: "sphinx", pos: { x: 8, y: 3 }, variant: 0 },
      ...
      { type: "statue", pos: { x: 12, y: 6 }, variant: 7 },
  ...
  sandbox: {
    ...
    decorations: [
      ...
      { type: "pine_tree", pos: { x: 12, y: 2 }, variant: 0 },
      { type: "pine_tree", pos: { x: 20, y: 2 }, variant: 1 },
