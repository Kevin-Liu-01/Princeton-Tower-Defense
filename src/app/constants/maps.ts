...
> = {
  ...
  ivy_crossroads: {
    ...
    hazards: [
      ...
      { type: "swamp", pos: { x: 15, y: 8 }, radius: 1.8 },
      { type: "poison", pos: { x: 24, y: 18 }, radius: 2.1 },
    ],
    decorations: [
  ...
  blight_basin: {
    ...
    hazards: [
      ...
      { type: "void", pos: { x: 24, y: 18 }, radius: 2.1 },
  ...
  sunscorch_labyrinth: {
    ...
    hazards: [
      ...
      { type: "fire", pos: { x: 23, y: 12 }, radius: 2.2 },
      { type: "lightning", pos: { x: 18.5, y: 13 }, radius: 2.4 },
    ],
    decorations: [
      {
  ...
  triad_keep: {
    ...
    hazards: [
      { type: "poison_fog", pos: { x: 13, y: 14 }, radius: 2.2 },
      { type: "swamp", pos: { x: 20, y: 12 }, radius: 1.8 },
      { type: "void", pos: { x: 26, y: 18 }, radius: 1.7 },
    ],
    decorations: [
  ...
  frontier_outpost: {
    ...
    hazards: [
      { type: "storm_field", pos: { x: 13, y: 9 }, radius: 2.1 },
  ...
  sun_obelisk: {
    ...
    specialTowers: [
      { pos: { x: 10, y: 8 }, type: "sunforge_orrery" },
      { pos: { x: 22, y: 20 }, type: "beacon", hp: 500 },
      { pos: { x: 16, y: 15 }, type: "chrono_relay" },
      { pos: { x: 8, y: 22 }, type: "sentinel_nexus" },
    ],
    hazards: [
      { type: "quicksand", pos: { x: 14, y: 8 }, radius: 2 },
      { type: "fire", pos: { x: 22, y: 10 }, radius: 2.2 },
      { type: "quicksand", pos: { x: 18, y: 22 }, radius: 1.8 },
    ],
    decorations: [
  ...
  infernal_gate: {
    ...
    specialTowers: [
      { pos: { x: 14, y: 10 }, type: "vault", hp: 800 },
      { pos: { x: 22, y: 22 }, type: "barracks" },
      { pos: { x: 8, y: 16 }, type: "sentinel_nexus" },
      { pos: { x: 26, y: 12 }, type: "sunforge_orrery" },
      { pos: { x: 16, y: 20 }, type: "chrono_relay" },
    ],
    hazards: [
      { type: "lava_geyser", pos: { x: 12, y: 12 }, radius: 2.2 },
      { type: "lava_geyser", pos: { x: 24, y: 20 }, radius: 2.2 },
      { type: "volcano", pos: { x: 18, y: 24 }, radius: 2.5 },
      { type: "fire", pos: { x: 8, y: 8 }, radius: 1.8 },
    ],
    decorations: [
