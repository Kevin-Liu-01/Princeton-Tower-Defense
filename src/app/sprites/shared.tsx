...
export const SPECIAL_TOWER_SPRITE_THEME: Record<SpecialTowerType, SpriteFrameTheme> = {
  vault: {
    background: "radial-gradient(circle at 50% 50%, rgba(254,240,138,0.3), rgba(120,80,18,0.18) 42%, rgba(60,41,12,0.95) 100%)",
    border: "rgba(250,204,21,0.7)",
    glow: "rgba(250,204,21,0.42)",
  },
  beacon: {
    background: "radial-gradient(circle at 50% 50%, rgba(165,243,252,0.28), rgba(18,92,112,0.18) 42%, rgba(12,48,60,0.96) 100%)",
    border: "rgba(34,211,238,0.7)",
    glow: "rgba(34,211,238,0.4)",
  },
  shrine: {
    background: "radial-gradient(circle at 50% 50%, rgba(187,247,208,0.28), rgba(20,105,70,0.18) 42%, rgba(12,64,44,0.96) 100%)",
    border: "rgba(34,197,94,0.7)",
    glow: "rgba(34,197,94,0.38)",
  },
  barracks: {
    background: "radial-gradient(circle at 50% 50%, rgba(254,202,202,0.25), rgba(158,42,42,0.2) 42%, rgba(74,22,22,0.96) 100%)",
    border: "rgba(248,113,113,0.72)",
    glow: "rgba(248,113,113,0.4)",
  },
  chrono_relay: {
    background: "radial-gradient(circle at 50% 50%, rgba(199,210,254,0.28), rgba(91,94,197,0.2) 42%, rgba(38,34,96,0.96) 100%)",
    border: "rgba(129,140,248,0.72)",
    glow: "rgba(129,140,248,0.42)",
  },
  sentinel_nexus: {
    background: "radial-gradient(circle at 50% 50%, rgba(254,205,211,0.28), rgba(160,46,78,0.2) 42%, rgba(78,24,46,0.96) 100%)",
    border: "rgba(251,113,133,0.72)",
    glow: "rgba(251,113,133,0.4)",
  },
  sunforge_orrery: {
    background: "radial-gradient(circle at 50% 50%, rgba(254,215,170,0.27), rgba(174,87,30,0.2) 42%, rgba(94,38,20,0.96) 100%)",
...
export const HAZARD_SPRITE_THEME: Partial<Record<HazardType, SpriteFrameTheme>> = {
  poison_fog: {
    background: "radial-gradient(circle at 50% 50%, rgba(187,247,208,0.28), rgba(28,120,71,0.18) 42%, rgba(14,66,42,0.96) 100%)",
    border: "rgba(74,222,128,0.7)",
    glow: "rgba(74,222,128,0.4)",
  },
  deep_water: {
    background: "radial-gradient(circle at 50% 50%, rgba(191,219,254,0.28), rgba(35,96,176,0.18) 42%, rgba(17,52,98,0.96) 100%)",
    border: "rgba(96,165,250,0.7)",
    glow: "rgba(96,165,250,0.42)",
  },
  maelstrom: {
    background: "radial-gradient(circle at 50% 50%, rgba(186,230,253,0.27), rgba(34,124,159,0.18) 42%, rgba(12,56,77,0.96) 100%)",
    border: "rgba(56,189,248,0.72)",
    glow: "rgba(56,189,248,0.42)",
  },
  storm_field: {
    background: "radial-gradient(circle at 50% 50%, rgba(219,234,254,0.26), rgba(76,107,202,0.18) 42%, rgba(31,43,100,0.96) 100%)",
    border: "rgba(125,211,252,0.72)",
    glow: "rgba(125,211,252,0.42)",
  },
  quicksand: {
    background: "radial-gradient(circle at 50% 50%, rgba(254,249,195,0.27), rgba(188,146,47,0.18) 42%, rgba(108,78,28,0.96) 100%)",
    border: "rgba(250,204,21,0.72)",
    glow: "rgba(250,204,21,0.42)",
  },
  ice_sheet: {
    background: "radial-gradient(circle at 50% 50%, rgba(224,242,254,0.28), rgba(99,159,214,0.18) 42%, rgba(32,68,98,0.96) 100%)",
    border: "rgba(125,211,252,0.72)",
    glow: "rgba(125,211,252,0.4)",
  },
  ice_spikes: {
    background: "radial-gradient(circle at 50% 50%, rgba(219,234,254,0.28), rgba(90,130,218,0.18) 42%, rgba(32,58,112,0.96) 100%)",
    border: "rgba(96,165,250,0.72)",
    glow: "rgba(96,165,250,0.43)",
  },
  lava_geyser: {
    background: "radial-gradient(circle at 50% 50%, rgba(254,215,170,0.28), rgba(218,99,41,0.18) 42%, rgba(110,37,22,0.96) 100%)",
    border: "rgba(251,146,60,0.74)",
...
export const FramedSprite: React.FC<{
  ...
  >
    ...
    <div
      ...
      style={{
        background: "radial-gradient(circle at 50% 50%, rgba(255,255,255,0.22), rgba(255,255,255,0.03) 38%, rgba(0,0,0,0.25) 90%)",
      }}
    />
...
export const SpecialTowerSprite: React.FC<{ type: SpecialTowerType; size?: number; animated?: boolean }> = ({ type, size = 48, animated = false }) => {
  ...
  const render = useCallback(
    (time: number) => {
      ...
      drawSpecialBuildingSprite(ctx, size / 2, size * 0.62, size * 0.45, type, t);
    },
    [type, size, animated],
  );
...
export const HazardSprite: React.FC<{ type: HazardType; size?: number; animated?: boolean }> = ({ type, size = 48, animated = false }) => {
  const canvasRef = useRef<HTMLCanvasElement>(null);
