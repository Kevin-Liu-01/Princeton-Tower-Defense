...
const HERO_ICON_MAP: Record<HeroType, React.FC<{ size?: number; className?: string }>> = {
  tiger: ({ size = 16, className }) => <Cat size={size} className={className} />,
  tenor: ({ size = 16, className }) => <Mic size={size} className={className} />,
  mathey: ({ size = 16, className }) => <Shield size={size} className={className} />,
  rocky: ({ size = 16, className }) => <Squirrel size={size} className={className} />,
